...
%      specific requests\\
  ...
  \end{tikzpicture}
  \caption{This axis extends Linked Data Fragments with Linked Connections. Different ticks on the axis illustrate client effort versus server expressivity.}
  \label{fig:LDFAxis2}
\end{figure}