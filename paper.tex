...
All except the Route Planning 
We are particularly intersted in studying the potential application of route planning queries for flow analysis thus only requests to (\url{http://api.irail.be/connections/{?from,to,date,time}}) were extracted for further investigation.
