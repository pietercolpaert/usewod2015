...
% Task
We analysed the query logs of the iRail API, a high expressive route planning API for the Belgian railways, to get an indication of travel flows between cities in Belgium.
...
% Conclusion
We concluded that query logs of route planners are of high importance in getting an indication of the travel flows.
% Perspectives
\todo{another sentence about publishing transit data for maximized reuse and how to gather analytics}
