...
\begin{figure*}
  ...
  \begin{subfigure}{.475\textwidth}
    \includegraphics[width=8cm]{method-a.pdf}\\
    \subcaption{Spatial aggregation based on provincial administrative boundaries}
    \label{fig:method-a}
  \end{subfigure}%
  \begin{subfigure}{.475\textwidth}
    \includegraphics[width=8cm]{method-b.pdf}\\
    \subcaption{\todo{Alvin: caption to explain what this is}}
    \label{fig:method-b}
  \end{subfigure}%
  \hfill%
  \begin{subfigure}{0.9\textwidth}
    \includegraphics[width=15cm]{method-c.pdf}\\
    \subcaption{Yet another subfigure \todo{Alvin: caption to explain what this is}}
    \label{fig:method-c}
  \end{subfigure}%
  \caption{General caption of the image \todo{Alvin: caption to explain what this is}}
  \label{fig:method}
\end{figure*}
