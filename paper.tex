...
The data is formatted in a manner where data records with matching pairs of origin and destination (OD) station names are aggregated. 
To arrive at this outcome several technical challenges must be addressed.
One distinctive challenge is the substantial amount of inconsistency in the manner where origin and destination (OD) station names are defined. 
Spelling mistakes as well as the use of unstandardized abbreviations in particular, reduce the quality and accuracy of aggregation.
To overcome this challenge, an open-source reconciliator (\url{https://github.com/irail/stations}) was employed to reduce spelling variations and correct identifiable errors.
