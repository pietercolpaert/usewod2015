...
\numberofauthors{6}
\author{\alignauthor
Pieter Colpaert\textsuperscript{*}
\and
\alignauthor
...
Queries from Flanders, on the other hand, tend to be distributed among four major cities otherwise known as the Flemish Diamond, a network of metropolitan areas in Belgium comprised of Brussels, Antwerp (see \cref{fig:mornings}b), Ghent (see \cref{fig:mornings}c) and Leuven (see \cref{fig:mornings}d). 
