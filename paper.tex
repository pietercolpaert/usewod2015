...
However, we do not store the query logs for the data, which 
...
To do so, we chose to assemble the smaller stations under their lager administrative unit: provinces.
