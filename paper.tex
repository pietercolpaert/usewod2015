...
Each row within this dataset contains a timestamp of when the request was executed, the request path between two stations with longitudes and latitudes, the user-agent string cfr. RFC2616, the operating system of the user-agent and whether or not the user-agent is a bot.
