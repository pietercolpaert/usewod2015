...
Likewise, insight into routine travel patterns is crucial for the conceptualisation of functional urban areas~\cite{servillo2013town}, urban hierarchies~\cite{christaller1966central} and other territorial structures.
...
%We can observe that Brussels, Antwerp, Gent and Leuven are the dominant destinations.
%Turning our attention to weekday travel, we can observe that Antwerp, Brussels and Gent are the dominant destinations.
