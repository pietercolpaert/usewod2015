...
% Object & Findings
We illustrate that we can see morning and evening peaks in the query logs.
Moreover, using origin-destination visualizations, we can confirm that Brussels, the capital, acts as a central hub.
