...
It is a high expresive webservice, of which the query logs are able to tell us something about the public transit demand at a certain moment.
...
Yet, getting indications of these travel flows has proven to be troublesome.
% Task
...
% Findings
Using data visualizations, we illustrate two interesting patterns that correspond to reality, as confirmed by experts, and we show one that does not.
% Conclusion
