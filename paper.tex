...
The chance that two requests are exactly the same for a high expressive server is low. 
We have shown in previous sections that these logs are interesting.

A low expressive server that still publishes the data in a queryable way as illustrated in \cref{fig:lc}, exploits the caching mechanism 
